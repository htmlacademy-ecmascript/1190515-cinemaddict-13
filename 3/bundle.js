...
filmsListExtra.forEach((element) => {
  ...
  if (element[0]) {
    for (let i = 0; i < EXTRA_CARD_COUNT; i++) {
      render(filmsListContainerElement, Object(_view_top_rated_cards_js__WEBPACK_IMPORTED_MODULE_6__["createTopRatedTemplate"])(), `afterbegin`);
    }
  }
  if (element[filmsListExtra.length - 1]) {
    for (let i = 0; i < EXTRA_CARD_COUNT; i++) {
      render(filmsListContainerElement, Object(_view_most_commented_cards_js__WEBPACK_IMPORTED_MODULE_7__["createMostCommentedTemplate"])(), `afterbegin`);
    }
  }
  // return element;
});
...
render(footerStatisticsElement, Object(_view_statistics_js__WEBPACK_IMPORTED_MODULE_8__["createStatisticsTemplate"])(), `afterbegin`);
